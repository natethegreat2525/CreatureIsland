...
public class Blocks {
	public static void init() {
		...
		BlockContainer.blockTypes[8] = new LowPolyBlock(7, 4, 4, new Vector4f(1, 1, 1, 1), new Vector3f(.3f, 0, .3f), new Vector3f(.7f, .6f, .7f), 2);
		BlockContainer.blockTypes[11] = new LowPolyBlock(10, 4, 4, new Vector4f(1, 1, 1, 1), new Vector3f(.3f, 0, .3f), new Vector3f(.7f, .6f, .7f), 2);
		BlockContainer.blockTypes[12] = new LowPolyBlock(11, 4, 4, new Vector4f(1, 1, 1, 1), 2);
